...
<body class="bg-slate-200 flex items-center justify-center w-screen h-screen">
  <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-4 items-center justify-center rounded-lg border border-slate-300 p-5 shadow-sm bg-slate-100 w-96">
    <h1 class="text-2xl font-semibold font-montserrat">Voting App - Register</h1>
    @csrf
    <div class="w-full">
    ...
    <div class="w-full flex justify-center">
      <a href="/login" class="text-slate-700 text-lg font-semibold transition transition-300 hover:text-slate-900">Login</a>
    </div>
    <div class="w-full">
      @error('name')
